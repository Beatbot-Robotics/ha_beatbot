"""Config flow for the Beatbot Home integration using OAuth2 with PKCE."""
...
class BeatbotConfigFlow(
    ...
    """Handle a config flow for Beatbot Home via OAuth2 + PKCE."""
    ...
    async def async_oauth_create_entry(
        ...
        return self.async_create_entry(title="Beatbot Home", data=data)
